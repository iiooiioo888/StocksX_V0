...
class UserDB:
    ...
    def _init_system_products(self) -> None:
        ...
        _sys = [
            ...
            ("AMD", "Advanced Micro Devices", "yfinance", "traditional", "美股"),
            ("AVGO", "Broadcom", "yfinance", "traditional", "美股"),
            ("ASML", "ASML Holding", "yfinance", "traditional", "美股"),
            ("TSM", "Taiwan Semiconductor (ADR)", "yfinance", "traditional", "美股"),
            ("CRM", "Salesforce", "yfinance", "traditional", "美股"),
            ("ADBE", "Adobe", "yfinance", "traditional", "美股"),
            ("NOW", "ServiceNow", "yfinance", "traditional", "美股"),
            ("SNOW", "Snowflake", "yfinance", "traditional", "美股"),
            ("PLTR", "Palantir", "yfinance", "traditional", "美股"),
            # 台股
            ...
            ("XLK", "Technology Select Sector SPDR", "yfinance", "traditional", "ETF"),
            ("XLF", "Financial Select Sector SPDR", "yfinance", "traditional", "ETF"),
            ("XLE", "Energy Select Sector SPDR", "yfinance", "traditional", "ETF"),
            ("XLY", "Consumer Discretionary SPDR", "yfinance", "traditional", "ETF"),
            ("XLU", "Utilities Select Sector SPDR", "yfinance", "traditional", "ETF"),
            ("ARKK", "ARK Innovation ETF", "yfinance", "traditional", "ETF"),
            ("ARKW", "ARK Next Generation Internet ETF", "yfinance", "traditional", "ETF"),
            # 期貨
