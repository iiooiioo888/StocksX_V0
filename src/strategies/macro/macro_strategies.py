...
class SeasonalStrategy(BaseStrategy):
    ...
    def __init__(self, lookback_years: int = 10):
        ...
        Args:
            lookback_years: 回看年數
        """
        super().__init__("季節性策略", {"lookback_years": lookback_years}, category="macro")
...
class DXYCorrelation(BaseStrategy):
    ...
    def __init__(self, lookback: int = 60, threshold: float = 0.5):
        ...
        Args:
            ...
            threshold: 相關性閾值
        """
        super().__init__("美元指數聯動", {"lookback": lookback, "threshold": threshold}, category="macro")
...
class YieldCurve(BaseStrategy):
    ...
    def __init__(self, short_rate: float = 0.02, long_rate: float = 0.04):
        ...
        Args:
            ...
            long_rate: 長期利率基準
        """
        super().__init__("收益率曲線策略", {"short_rate": short_rate, "long_rate": long_rate}, category="macro")
...
class VIXTrading(BaseStrategy):
    ...
    def __init__(self, high_vix: float = 30, low_vix: float = 15):
        ...
        Args:
            ...
            low_vix: 低 VIX 閾值
        """
        super().__init__("VIX 期貨交易", {"high_vix": high_vix, "low_vix": low_vix}, category="macro")
...
class CountryRotation(BaseStrategy):
    ...
    def __init__(self, lookback: int = 3, momentum_period: int = 12):
        ...
        """
        super().__init__("跨國權益輪動", {"lookback": lookback, "momentum_period": momentum_period}, category="macro")
