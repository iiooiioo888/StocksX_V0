...
class FisherTransform(OscillatorStrategy):
    ...
    def __init__(self, period: int = 10):
        ...
        Args:
            period: 周期（默认 10）
        """
        super().__init__("Fisher Transform", {"period": period})
...
class ElderRay(OscillatorStrategy):
    ...
    def __init__(self, ema_period: int = 13):
        ...
        """
        super().__init__("Elder Ray", {"ema_period": ema_period})
...
class KlingerOscillator(OscillatorStrategy):
    ...
    def __init__(self, fast_period: int = 34, slow_period: int = 55, signal_period: int = 13):
        ...
        """
        super().__init__(
            "Klinger 振盪", {"fast_period": fast_period, "slow_period": slow_period, "signal_period": signal_period}
        )
    ...
    def calculate_klinger(self, data: pd.DataFrame) -> dict[str, pd.Series]:
        ...
        return {"klinger": klinger, "signal": signal}
...
class ChandeMomentumOscillator(OscillatorStrategy):
    ...
    def __init__(self, period: int = 14, overbought: float = 50, oversold: float = -50):
        ...
        Args:
            ...
            oversold: 超賣線（默认 -50）
        """
        super().__init__("Chande 動量振盪", {"period": period, "overbought": overbought, "oversold": oversold})
...
class DetrendedPriceOscillator(OscillatorStrategy):
    ...
    def __init__(self, period: int = 20):
        ...
        Args:
            period: 周期（默认 20）
        """
        super().__init__("Detrended Price Oscillator", {"period": period})
...
class UlcerIndex(OscillatorStrategy):
    ...
    def __init__(self, period: int = 14):
        ...
        Args:
            period: 周期（默认 14）
        """
        super().__init__("Ulcer Index", {"period": period})
...
class MassIndex(OscillatorStrategy):
    ...
    def __init__(self, period: int = 9, threshold_high: float = 27, threshold_low: float = 26.5):
        """
        初始化 Mass Index
        ...
        """
        super().__init__(
            "Mass Index", {"period": period, "threshold_high": threshold_high, "threshold_low": threshold_low}
        )
