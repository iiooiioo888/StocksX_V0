...
class IchimokuBacktester:
    ...
    def grid_search(self, data: pd.DataFrame, param_grid: dict[str, list[int]]) -> pd.DataFrame:
        """
        參數網格搜索
...
def main():
    ...
    # 創建回測引擎
    print("\n[2/4] 初始化回測引擎...")
    backtester = IchimokuBacktester(initial_capital=100000.0, commission_rate=0.001, slippage=0.001)
