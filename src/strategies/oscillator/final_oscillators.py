...
class MultiRSI(OscillatorStrategy):
    ...
    def __init__(self, periods: list[int] = None, overbought: float = 70, oversold: float = 30):
        """
        初始化 Multi-RSI
        ...
        super().__init__("Multi-RSI", {"periods": periods, "overbought": overbought, "oversold": oversold})
...
class AdaptiveKD(OscillatorStrategy):
    ...
    def __init__(self, base_n: int = 9, base_m1: int = 3, base_m2: int = 3, volatility_period: int = 14):
        """
        初始化 Adaptive KD
        ...
        super().__init__(
            "Adaptive KD",
            {"base_n": base_n, "base_m1": base_m1, "base_m2": base_m2, "volatility_period": volatility_period},
        )
...
class BollingerPercentB(OscillatorStrategy):
    ...
    def __init__(self, period: int = 20, num_std: float = 2.0):
        ...
        """
        super().__init__("Bollinger %B", {"period": period, "num_std": num_std})
...
class CustomOscillator(OscillatorStrategy):
    ...
    def __init__(
        self, rsi_period: int = 14, kd_n: int = 9, macd_fast: int = 12, macd_slow: int = 26, macd_signal: int = 9
    ):
        """
