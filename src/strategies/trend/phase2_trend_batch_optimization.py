...
class EMACrossOptimized(BaseStrategy):
    ...
    def __init__(
        self, short_period: int = 12, long_period: int = 26, use_ema_filter: bool = True, signal_smoothing: bool = True
    ):
        super().__init__(
            "EMA Cross Optimized",
            {
...
class ParabolicSAROptimized(BaseStrategy):
    ...
    def __init__(
        self, af_start: float = 0.02, af_step: float = 0.02, af_max: float = 0.2, use_trend_filter: bool = True
    ):
        super().__init__(
            "Parabolic SAR Optimized",
            {"af_start": af_start, "af_step": af_step, "af_max": af_max, "use_trend_filter": use_trend_filter},
            category="trend",
        )
...
class DonchianChannelOptimized(BaseStrategy):
    ...
    def __init__(self, period: int = 20, use_breakout_filter: bool = True, volume_confirmation: bool = True):
        super().__init__(
            "Donchian Channel Optimized",
            {"period": period, "use_breakout_filter": use_breakout_filter, "volume_confirmation": volume_confirmation},
            category="trend",
        )
...
class MARibbonOptimized(BaseStrategy):
    ...
    def __init__(
        self, short_period: int = 10, long_period: int = 30, num_mas: int = 5, use_ribbon_alignment: bool = True
    ):
        super().__init__(
            "MA Ribbon Optimized",
            {
...
def main():
    ...
    ema_best, ema_results = optimize_strategy(
        data, EMACrossOptimized, {"short_period": [9, 12, 15], "long_period": [21, 26, 30]}, "EMA Cross"
    )
    ...
    psar_best, psar_results = optimize_strategy(
        data,
        ParabolicSAROptimized,
        {"af_start": [0.01, 0.02], "af_step": [0.01, 0.02], "af_max": [0.15, 0.20]},
        "Parabolic SAR",
    )
    ...
    donchian_best, donchian_results = optimize_strategy(
        data, DonchianChannelOptimized, {"period": [15, 20, 25]}, "Donchian Channel"
    )
    ...
    ribbon_best, ribbon_results = optimize_strategy(
        data,
        MARibbonOptimized,
        {"short_period": [8, 10, 12], "long_period": [25, 30, 35], "num_mas": [4, 5, 6]},
        "MA Ribbon",
    )
