...
class MovingAverageRibbon(TrendFollowingStrategy):
    ...
    def __init__(self, periods: list[int] = None):
        ...
        super().__init__("均线带（Ribbon）", {"periods": periods})
...
class TurtleTrading(TrendFollowingStrategy):
    ...
    def __init__(self, entry_period: int = 20, exit_period: int = 10, atr_period: int = 14, risk_multiple: float = 2.0):
        """
        初始化海龟交易法
...
class CCI(TrendFollowingStrategy):
    ...
    def __init__(self, period: int = 20, overbought: float = 100, oversold: float = -100):
        ...
        Args:
            ...
            oversold: 超卖线（默认 -100）
        """
        super().__init__("CCI 商品通道", {"period": period, "overbought": overbought, "oversold": oversold})
    ...
    def calculate_cci(self, data: pd.DataFrame) -> pd.Series:
        ...
        # 计算平均偏差
        mean_deviation = tp.rolling(window=period).apply(lambda x: np.abs(x - x.mean()).mean(), raw=True)
...
class KAMA(TrendFollowingStrategy):
    ...
    def __init__(self, period: int = 10, fast_period: int = 2, slow_period: int = 30):
        ...
        """
        super().__init__("KAMA 自适应均线", {"period": period, "fast_period": fast_period, "slow_period": slow_period})
...
class ZLEMA(TrendFollowingStrategy):
    ...
    def __init__(self, period: int = 21):
        ...
        """
        super().__init__("ZLEMA 零滞后 EMA", {"period": period})
...
class T3Average(TrendFollowingStrategy):
    ...
    def __init__(self, period: int = 14, v_factor: float = 0.7):
        ...
        """
        super().__init__("T3 均線", {"period": period, "v_factor": v_factor})
...
class TillsonT3(TrendFollowingStrategy):
    ...
    def __init__(self, period: int = 14, v_factor: float = 0.7):
        ...
        """
        super().__init__("Tillson T3", {"period": period, "v_factor": v_factor})
