...
__all__ = ['TREND_COMPLETE_STRATEGIES', 
           'SMACross', 'EMACross', 'MACDCross', 'ADXStrategy',
           'Supertrend', 'ParabolicSAR', 'DonchianChannel', 
           'DualThrust', 'VWAPReversion']
