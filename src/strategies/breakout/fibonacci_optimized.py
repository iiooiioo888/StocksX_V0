...
def main():
    ...
    # 創建回測引擎
    print("\n[2/4] 初始化回測引擎...")
    backtester = FibonacciBacktester(initial_capital=100000.0, commission_rate=0.001, slippage=0.001)

    # 參數網格搜索
    print("\n[3/4] 執行參數網格搜索...")
    param_grid = {"lookback": [40, 50, 60], "primary_fib": [0.5, 0.618, 0.786], "secondary_fib": [0.382, 0.5]}
