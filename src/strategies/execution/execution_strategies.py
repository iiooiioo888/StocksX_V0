...
class VWAPExecution(BaseStrategy):
    ...
    def __init__(self, lookback: int = 20):
        ...
        Args:
            lookback: 回看週期
        """
        super().__init__("VWAP 執行", {"lookback": lookback}, category="execution")
...
class TWAPExecution(BaseStrategy):
    ...
    def __init__(self, intervals: int = 10, lookback: int = 50):
        ...
        Args:
            ...
            lookback: 回看週期
        """
        super().__init__("TWAP 執行", {"intervals": intervals, "lookback": lookback}, category="execution")
...
class MarketMaking(BaseStrategy):
    ...
    def __init__(self, spread_pct: float = 0.001, order_size: float = 0.01):
        ...
        Args:
            ...
            order_size: 訂單大小比例
        """
        super().__init__("做市策略", {"spread_pct": spread_pct, "order_size": order_size}, category="execution")
...
class ImplementationShortfall(BaseStrategy):
    ...
    def __init__(self, target_weight: float = 0.5, urgency: float = 0.5):
        ...
        """
        super().__init__(
            "Implementation Shortfall", {"target_weight": target_weight, "urgency": urgency}, category="execution"
        )
