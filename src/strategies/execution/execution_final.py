...
class SniperStrategy(BaseStrategy):
    ...
    def __init__(self, volume_threshold: float = 3.0, lookback: int = 20):
        super().__init__('Sniper Strategy', {
...
class IcebergOrders(BaseStrategy):
    ...
    def __init__(self, max_visible_pct: float = 0.05, refresh_rate: int = 5):
        super().__init__('Iceberg Orders', {
            'max_visible_pct': max_visible_pct,
...
__all__ = ['EXECUTION_FINAL_STRATEGIES',
           'SniperStrategy', 'IcebergOrders', 'POVStrategy', 
           'ArrivalPrice', 'ImplementationShortfallEnhanced']
