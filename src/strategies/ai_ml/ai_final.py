...
class TransferLearning(BaseStrategy):
    ...
    def __init__(self, source_market: str = 'US', target_market: str = 'TW', 
                 lookback: int = 60):
        super().__init__('遷移學習', {
...
class PairTrading(BaseStrategy):
    ...
    def __init__(self, partner_symbol: str = 'PARTNER', 
...
__all__ = ['AI_ML_FINAL_STRATEGIES', 
           'TransferLearning', 'ContrastiveLearning', 'LSTMPredictor',
           'DQNAgent', 'MultiFactorModel', 'PairTrading', 'EnsembleVotingFinal']
