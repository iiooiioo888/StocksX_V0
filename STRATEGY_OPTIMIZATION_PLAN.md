...
### ✅ #41 統計套利 (stat_arb) — 2026-03-23

| 項目 | 原始值 | 優化後 | 變化 |
|------|--------|--------|------|
| lookback | 60 | **20** | -67% |
| z_threshold | 2.5 | **2.5** | 不變 |
| Sharpe Ratio | -0.264 | **1.029** | +1.293 (從負轉正) |
| 年化收益 | -1.59% | **+2.15%** | +3.74pp |
| 最大回撤 | -4.28% | **-1.05%** | 改善 75% |
| 交易次數 | 7 | **14** | +100% |
| 勝率 | — | **71.4%** | — |
| 盈虧比 | — | **6.95** | — |

**關鍵洞察**: 縮短 lookback (60→20) 是核心改善，使 z-score 更敏感捕捉均值回歸。低 z_threshold (<2.0) 會過度交易導致虧損。
...
|-------|------|------|----------|----------|
| #41 | 統計套利 | `stat_arb` | 3年回測 + z-score優化 | ✅ **已完成** (Sharpe=1.029) |
